...
const CONN_DEFS = {
  ...
  lms: { label:"LMS (TutorLMS)", icon:Users, color:"#10b981", desc:"Course progress, completions, engagement", docs:"https://tutorlms.com/rest-api/", fields:[{key:"siteUrl",label:"WordPress URL",placeholder:"https://nevgoinstitute.com",type:"text"},{key:"apiKey",label:"API Key",placeholder:"key_2...",type:"text"},{key:"apiSecret",label:"API Secret",placeholder:"secret_a4...",type:"password"}] },
  ...
  tavily: { label:"Tavily Search", icon:MessageSquare, color:"#3b82f6", desc:"AI web search untuk Agent Insight & Competitor Pipeline", docs:"https://app.tavily.com/", fields:[{key:"apiKey",label:"API Key",placeholder:"tvly-xxxxxxxxxxxxxxxxxx",type:"password"}] },
};

const FASE1 = ["woocommerce","ga4","searchConsole","lms","uptimerobot","pagespeed","sendgrid","openrouter","tavily"];
